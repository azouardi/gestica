...
class Profile(models.Model):
    user = models.OneToOneField(User, on_delete=models.SET_NULL,null=True, verbose_name="Utilisateur")
    ...
    office = models.ForeignKey(Office, on_delete=models.SET_NULL, verbose_name= "Cabinet", null=True, blank=True)
...
class Portefolio(models.Model):
    ...
    rolecollaborateur= models.ForeignKey(Scope, on_delete=models.CASCADE, verbose_name="En charge de", null=True)
...
class Manager(models.Model):
    id = models.UUIDField(primary_key=True,default=uuid.uuid4,editable=False)
    user = models.ForeignKey(Profile, null=True, on_delete= models.SET_NULL,verbose_name="Manager")   
    lettremission = models.ForeignKey(LettreMission, on_delete=models.CASCADE, verbose_name="Mission", null=True)
    active = models.BooleanField(verbose_name="Active sur le dossier", default = True)
    date_created = models.DateTimeField(auto_now_add=True, null=True, verbose_name="Date création")    
    class Meta:
